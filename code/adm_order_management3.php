...
<head>
    ...
    <body>
        ...
        <div class = menu>
            ...
            <div class="tab-button" id="picked" onclick="showTab('picked'); location.href='adm_order_management2.php'" >已取車</div>
            <div class="tab-button active" id="returned" onclick="showTab('returned'); location.href='adm_order_management3.php'">已還車</div>
        </div>
    </div>    
        ...
        <tbody>
            <?php
                ...
                $sql = "
                    ...
                    WHERE rent.REN_PICKUP_CONDITION LIKE '%已還車%'";
