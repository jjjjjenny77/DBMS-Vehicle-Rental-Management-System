...
<body>
    ...
    <div id="orderManagement" >
        <h1>訂單管理</h1>
        <div class = menu>
            <div class="tab-button " id="unpaid" onclick="showTab('unpaid'); location.href='order_management.php'">未取車</div>
            <div class="tab-button active" id="picked" onclick="showTab('picked'); location.href='order_management2.php'" >已取車</div>
				...
				<tbody>
                    <?php
							...
							$sql = "SELECT 
									...
									WHERE 
										RENT.CUS_IDNUM = '$id'
										AND (RENT.REN_PICKUP_CONDITION = '已取車')
										AND (RENT.REN_RETURN_CONDITION = '未還車')
									;";
